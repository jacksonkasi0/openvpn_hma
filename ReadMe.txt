...
* For Linux beginners we recommend using the "hma-openvpn.sh" script by simply running 
  "./hma-openvpn.sh" or "bash hma-openvpn.sh". This script asks you for only the most basic required 
...
* If for some reason you prefer the "old" script or the other two scripts don't properly work for you, 
